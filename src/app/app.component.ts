...
import {ChessBoardModel, ChessPieceBase, ChessPieceColor, ChessPieceType} from "./shared/models/chess-board-model";
...
ngOnInit(){
  ...
  console.log("Created a new Chess Piece => ", chessPiecePawn);
  console.log("Created a new Chess Piece => ", chessPieceRook);
